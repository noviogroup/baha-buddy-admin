...
export interface TripFlightRow { id: string; trip_id: string; origin: string; destination: string; departure_at: string | null; arrival_at: string | null; airline: string | null; booking_reference: string | null; price: number | null; duffel_offer_id: string | null; stripe_payment_intent_id: string | null; created_at: string; updated_at: string; }
